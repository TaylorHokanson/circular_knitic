// Circular Knitic Controller
// Taylor Hokanson and Dieter Kirkwood
// based on the work of Varvara Guljajeva & Mar Canet

// Button (not implemented): GND > Momentary > Pin 12
// Potentiometer: left pin GND, center pin A0, right pin 5VDC
// Encoder: left pin 3, center pin 2, right pin GND
...
void takeStep(){  
  ...
  motorJam++;
  Serial.println("MotorJAm: " + String(motorJam) + "\n");  
}
